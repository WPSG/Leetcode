/*
 * @Date: 2021-01-18 14:39:39
 * @LastEditors: ROC
 * @LastEditTime: 2021-01-18 15:44:15
 * @FilePath: \Leetcode\C++\0105-construct-binary-tree-from-preorder-and-inorder-traversal.cpp
 */
...
public:
    TreeNode* myBuildTree(vector<int>& preorder, vector<int>& inorder, int preorder_left, 
                          int preorder_right, int inorder_left, int inorder_right, unordered_map<int, int> &index){
